...
public class FCMMessagingService extends FirebaseMessagingService {
    ...
    public static void enqueueTokenToService(Context ctx, String token) {
        Intent intent = new Intent(ctx, FCMMessagingService.class);
        intent.setAction(ACTION_TOKEN_RECEIVED);
