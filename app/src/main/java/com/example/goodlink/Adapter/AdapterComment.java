    ...
    public class AdapterComment extends RecyclerView.Adapter<AdapterComment.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            FontSizeUtils.applySpecificFontSize(holder.commentTextView, FontSizeUtils.getFontSize(activity));
            FontSizeUtils.applySpecificFontSize(holder.nameUserTextView, FontSizeUtils.getFontSize(activity));
